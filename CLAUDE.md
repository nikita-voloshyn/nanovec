...
**Build system:** Cargo
**Phase:** Phases 1, 2, and 2.5 complete (MVP, server-side embeddings, search ergonomics — `clear` tool, expanded `stats`, `distance`/`similarity` fields). Phase 3 next (scalar → SIMD distance acceleration).
